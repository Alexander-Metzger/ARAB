...
sudo dnf install kbackup mpv mediawriter ktorrent asunder lutris neovim mullvad-vpn youtube-dl libreoffice libreoffice-langpack-de libreoffice-langpack-en libreoffice-TexMaths jami openshot blender cura tnftp hashcat audacity gimp inkscape
